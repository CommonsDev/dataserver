...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ProjectSheetSuggestedItem', fields ['projectsheet']
        db.delete_unique(u'projectsheet_projectsheetsuggesteditem', ['projectsheet_id'])


        # Changing field 'ProjectSheetSuggestedItem.projectsheet'
        db.alter_column(u'projectsheet_projectsheetsuggesteditem', 'projectsheet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projectsheet.ProjectSheet']))

    def backwards(self, orm):

        # Changing field 'ProjectSheetSuggestedItem.projectsheet'
        db.alter_column(u'projectsheet_projectsheetsuggesteditem', 'projectsheet_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projectsheet.ProjectSheet'], unique=True))
        # Adding unique constraint on 'ProjectSheetSuggestedItem', fields ['projectsheet']
        db.create_unique(u'projectsheet_projectsheetsuggesteditem', ['projectsheet_id'])
