...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSheetQuestionAnswer.selected_choices'
        db.add_column(u'projectsheet_projectsheetquestionanswer', 'selected_choices',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSheetQuestionAnswer.selected_choices'
        db.delete_column(u'projectsheet_projectsheetquestionanswer', 'selected_choices')
    ...
    models = {
        ...
        u'projectsheet.projectsheetquestionanswer': {
            ...
            'selected_choices': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
