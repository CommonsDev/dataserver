...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('projectsheet_projectsheetsuggesteditem', 'projectsheet_projectsheetquestionanswer')

    def backwards(self, orm):
        db.rename_table('projectsheet_projectsheetquestionanswer', 'projectsheet_projectsheetsuggesteditem')
