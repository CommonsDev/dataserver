...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSheetQuestion.slug'
        db.add_column(u'projectsheet_projectsheetquestion', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), null=True, populate_from=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSheetQuestion.slug'
        db.delete_column(u'projectsheet_projectsheetquestion', 'slug')
