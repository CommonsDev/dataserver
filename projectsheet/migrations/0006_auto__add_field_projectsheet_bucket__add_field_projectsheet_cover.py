...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectSheet.bucket'
        db.add_column(u'projectsheet_projectsheet', 'bucket',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bucket.Bucket'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectSheet.cover'
        db.add_column(u'projectsheet_projectsheet', 'cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bucket.BucketFile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectSheet.bucket'
        db.delete_column(u'projectsheet_projectsheet', 'bucket_id')

        # Deleting field 'ProjectSheet.cover'
        db.delete_column(u'projectsheet_projectsheet', 'cover_id')
