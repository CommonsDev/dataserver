...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProjectSheetQuestion.template'
        db.alter_column(u'projectsheet_projectsheetquestion', 'template_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True))
    ...
    models = {
        ...
        u'projectsheet.projectsheetquestion': {
            ...
            'template': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['projectsheet.ProjectSheetTemplate']", 'unique': 'True'}),
