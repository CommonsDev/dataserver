...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projectsheet_questionchoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='choices', to=orm['projectsheet.ProjectSheetQuestion'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'projectsheet', ['QuestionChoice'])


    def backwards(self, orm):
        # Deleting model 'QuestionChoice'
        db.delete_table(u'projectsheet_questionchoice')
    ...
    models = {
        ...
        u'projectsheet.projectsheetquestionanswer': {
            ...
            'selected_choices': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '255'})
        },
