...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marker.subtitle'
        db.add_column(u'scout_marker', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Marker.video_src'
        db.add_column(u'scout_marker', 'video_src',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Marker.picture_url'
        db.alter_column(u'scout_marker', 'picture_url', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Marker.subtitle'
        db.delete_column(u'scout_marker', 'subtitle')

        # Deleting field 'Marker.video_src'
        db.delete_column(u'scout_marker', 'video_src')


        # Changing field 'Marker.picture_url'
        db.alter_column(u'scout_marker', 'picture_url', self.gf('django.db.models.fields.URLField')(max_length=200))
