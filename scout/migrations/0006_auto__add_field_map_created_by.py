...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'scout_map', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='maps_created', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.created_by'
        db.delete_column(u'scout_map', 'created_by_id')
