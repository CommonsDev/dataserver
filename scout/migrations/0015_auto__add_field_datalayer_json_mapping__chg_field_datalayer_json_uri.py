...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataLayer.json_mapping'
        db.add_column(u'scout_datalayer', 'json_mapping',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)


        # Changing field 'DataLayer.json_uri'
        db.alter_column(u'scout_datalayer', 'json_uri', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting field 'DataLayer.json_mapping'
        db.delete_column(u'scout_datalayer', 'json_mapping')


        # Changing field 'DataLayer.json_uri'
        db.alter_column(u'scout_datalayer', 'json_uri', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'scout.datalayer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'json_mapping': ('jsonfield.fields.JSONField', [], {'default': '{}', 'blank': 'True'}),
