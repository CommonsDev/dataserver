...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.privacy'
        db.add_column(u'scout_map', 'privacy',
                      self.gf('django.db.models.fields.CharField')(default='GROUP_RW_OTHERS_RO', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.privacy'
        db.delete_column(u'scout_map', 'privacy')
