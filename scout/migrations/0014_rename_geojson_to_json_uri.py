...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('scout_datalayer', 'geojson', 'json_uri')

    def backwards(self, orm):
        db.rename_column('scout_datalayer', 'json_uri', 'geojson')
    ...
    models = {
        ...
        u'scout.datalayer': {
            ...
            'json_uri': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
