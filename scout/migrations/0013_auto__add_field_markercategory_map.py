...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkerCategory.map'
        db.add_column(u'scout_markercategory', 'map',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='marker_categories', to=orm['scout.Map']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkerCategory.map'
        db.delete_column(u'scout_markercategory', 'map_id')
    ...
    models = {
        ...
        u'scout.place': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['scout.PostalAddress']"}),
