...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostalAddress.post_office_box_number'
        db.alter_column(u'scout_postaladdress', 'post_office_box_number', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'PostalAddress.address_locality'
        db.alter_column(u'scout_postaladdress', 'address_locality', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'PostalAddress.address_region'
        db.alter_column(u'scout_postaladdress', 'address_region', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'PostalAddress.postal_code'
        db.alter_column(u'scout_postaladdress', 'postal_code', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'PostalAddress.street_address'
        db.alter_column(u'scout_postaladdress', 'street_address', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'PostalAddress.post_office_box_number'
        db.alter_column(u'scout_postaladdress', 'post_office_box_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'PostalAddress.address_locality'
        db.alter_column(u'scout_postaladdress', 'address_locality', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PostalAddress.address_region'
        db.alter_column(u'scout_postaladdress', 'address_region', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PostalAddress.postal_code'
        db.alter_column(u'scout_postaladdress', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'PostalAddress.street_address'
        db.alter_column(u'scout_postaladdress', 'street_address', self.gf('django.db.models.fields.TextField')(null=True))
