...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Place'
        db.create_table(u'scout_place', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scout.PostalAddress'])),
            ('geo', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ))
        db.send_create_signal(u'scout', ['Place'])


    def backwards(self, orm):
        # Deleting model 'Place'
        db.delete_table(u'scout_place')
