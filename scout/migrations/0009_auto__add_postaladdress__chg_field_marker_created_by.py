...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scout_postaladdress', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('address_locality', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('address_region', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('post_office_box_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('postal_code', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('street_address', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'scout', ['PostalAddress'])


        # Changing field 'Marker.created_by'
        db.alter_column(u'scout_marker', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'PostalAddress'
        db.delete_table(u'scout_postaladdress')


        # Changing field 'Marker.created_by'
        db.alter_column(u'scout_marker', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Profile']))
