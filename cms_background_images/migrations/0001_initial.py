...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackgroundImagesPlugin'
        db.create_table(u'cmsplugin_backgroundimagesplugin', (
        ...
        db.send_create_signal(u'cms_background_images', ['BackgroundImagesPlugin'])


    def backwards(self, orm):
        # Deleting model 'BackgroundImagesPlugin'
        db.delete_table(u'cmsplugin_backgroundimagesplugin')
    ...
    models = {
        ...
        u'cms_background_images.backgroundimagesplugin': {
            'Meta': {'object_name': 'BackgroundImagesPlugin', 'db_table': "u'cmsplugin_backgroundimagesplugin'", '_ormbases': ['cms.CMSPlugin']},
    ...
    complete_apps = ['cms_background_images']