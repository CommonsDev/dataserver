...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bucket.created_by'
        db.add_column(u'bucket_bucket', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, related_name='buckets_created', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bucket.created_by'
        db.delete_column(u'bucket_bucket', 'created_by_id')
