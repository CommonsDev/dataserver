...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BucketFile.license'
        db.add_column(u'bucket_bucketfile', 'license',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BucketFile.author'
        db.add_column(u'bucket_bucketfile', 'author',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BucketFile.license'
        db.delete_column(u'bucket_bucketfile', 'license')

        # Deleting field 'BucketFile.author'
        db.delete_column(u'bucket_bucketfile', 'author')
