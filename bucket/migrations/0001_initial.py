...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bucket'
        db.create_table(u'bucket_bucket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'bucket', ['Bucket'])

        # Adding model 'BucketFile'
        db.create_table(u'bucket_bucketfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bucket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['bucket.Bucket'])),
            ...
            ('thumbnail_url', self.gf('django.db.models.fields.CharField')(max_length=2048)),
        ))
        db.send_create_signal(u'bucket', ['BucketFile'])

        # Adding model 'BucketFileComment'
        ...
        db.send_create_signal(u'bucket', ['BucketFileComment'])


    def backwards(self, orm):
        # Deleting model 'Bucket'
        db.delete_table(u'bucket_bucket')

        # Deleting model 'BucketFile'
        db.delete_table(u'bucket_bucketfile')

        # Deleting model 'BucketFileComment'
        db.delete_table(u'bucket_bucketfilecomment')
