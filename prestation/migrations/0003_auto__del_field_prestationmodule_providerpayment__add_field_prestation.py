...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PrestationModule.providerpayment'
        db.delete_column(u'prestation_prestationmodule', 'providerpayment')

        # Adding field 'PrestationModule.providerretribution'
        db.add_column(u'prestation_prestationmodule', 'providerretribution',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PrestationModule.providerpayment'
        db.add_column(u'prestation_prestationmodule', 'providerpayment',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Deleting field 'PrestationModule.providerretribution'
        db.delete_column(u'prestation_prestationmodule', 'providerretribution')
    ...
    models = {
        ...
        u'prestation.prestationmodule': {
            ...
            'commons': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['projects.Project']", 'symmetrical': 'False'}),
            'commonsretribution': ('django.db.models.fields.TextField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.TextField', [], {}),
            'providerretribution': ('django.db.models.fields.TextField', [], {}),
