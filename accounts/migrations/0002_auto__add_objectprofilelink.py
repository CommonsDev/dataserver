...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ObjectProfileLink'
        db.create_table(u'accounts_objectprofilelink', (
            ...
            ('detail', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('isValidated', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'accounts', ['ObjectProfileLink'])


    def backwards(self, orm):
        # Deleting model 'ObjectProfileLink'
        db.delete_table(u'accounts_objectprofilelink')
