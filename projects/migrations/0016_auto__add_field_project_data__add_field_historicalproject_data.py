...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projects_project', 'data',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalProject.data'
        db.add_column(u'projects_historicalproject', 'data',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'projects_project', 'data')

        # Deleting field 'HistoricalProject.data'
        db.delete_column(u'projects_historicalproject', 'data')
