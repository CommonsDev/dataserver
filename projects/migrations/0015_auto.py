...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'projects_project_related_projects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_project', models.ForeignKey(orm[u'projects.project'], null=False)),
            ('to_project', models.ForeignKey(orm[u'projects.project'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'projects_project_related_projects'))
