...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.language_code'
        db.add_column(u'projects_project', 'language_code',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalProject.language_code'
        db.add_column(u'projects_historicalproject', 'language_code',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.language_code'
        db.delete_column(u'projects_project', 'language_code')

        # Deleting field 'HistoricalProject.language_code'
        db.delete_column(u'projects_historicalproject', 'language_code')
