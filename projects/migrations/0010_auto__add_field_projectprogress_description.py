...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectProgress.description'
        db.add_column(u'projects_projectprogress', 'description',
                      self.gf('django.db.models.fields.CharField')(default='description', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectProgress.description'
        db.delete_column(u'projects_projectprogress', 'description')
